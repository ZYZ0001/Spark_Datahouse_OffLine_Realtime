...
import com.atguigu.realtime.server.RegisterStatsServer
import org.apache.spark.SparkConf
import org.apache.spark.streaming.{Seconds, StreamingContext}

object RegisterStatsController {
  def main(args: Array[String]): Unit = {
    ...
    val registerStatsServer = new RegisterStatsServer()
//    registerStatsServer.registerCountWithHistory(ssc)
//    registerStatsServer.registerCount(ssc)
    registerStatsServer.registerCountWithOffset(ssc)
